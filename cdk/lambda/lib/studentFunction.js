  ...
  try {
    ...
    switch (pathData) {
      ...
      case "GET /student/get_messages":
        ...
        break;
      // NOTE: POST /student/create_message and POST /student/create_ai_message
      // have been removed — V2 chatbot Lambda now handles message persistence
      // as the single write authority (DynamoDB canonical + RDS projection).
