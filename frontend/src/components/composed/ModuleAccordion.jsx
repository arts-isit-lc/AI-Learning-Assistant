        ...
        <AccordionPrimitive.Item value="module" className="border-0">
          <div className="flex items-center gap-2 py-1 px-2">
            <button
              ...
              className="cursor-grab touch-none rounded text-muted-foreground hover:text-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              {...attributes}
              {...listeners}
            >
        ...
        {editing ? (
          ...
          <>
            ...
            <button
              ...
              className="leading-4 text-muted-foreground hover:text-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
            ...
            <div className="ml-auto flex items-center gap-1 opacity-0 transition-opacity focus-within:opacity-100 group-hover:opacity-100">
              <button
                ...
                onClick={onDelete}
                className="rounded text-muted-foreground hover:text-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                <Icon icon={MdDelete} />
              </button>
            </div>
