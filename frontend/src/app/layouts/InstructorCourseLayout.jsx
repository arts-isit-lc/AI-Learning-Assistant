...
// matched to the admin nav): the active tab is black (#000 / neutral-900) with a
// border-primary underline and no hover; inactive tabs are brand purple
// (text-primary) and take the rounded brand-"lightest" hover fill (#F2E8FF /
